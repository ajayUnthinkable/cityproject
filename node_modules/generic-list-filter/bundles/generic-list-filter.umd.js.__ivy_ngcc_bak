(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('moment'), require('lodash'), require('@angular/common'), require('@angular/forms'), require('ngx-material-timepicker')) :
    typeof define === 'function' && define.amd ? define('generic-list-filter', ['exports', '@angular/core', 'moment', 'lodash', '@angular/common', '@angular/forms', 'ngx-material-timepicker'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['generic-list-filter'] = {}, global.ng.core, global.moment, global._, global.ng.common, global.ng.forms, global.ngxMaterialTimepicker));
}(this, (function (exports, core, moment, _, common, forms, ngxMaterialTimepicker) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var GenericListFilterComponent = /** @class */ (function () {
        function GenericListFilterComponent() {
        ...
        GenericListFilterComponent.prototype.ngOnInit = function () {
        };
        GenericListFilterComponent.prototype.ngOnChanges = function () {
            var _this = this;
            //Called before any other lifecycle hook. Use it to inject dependencies, but avoid any serious work here.
            //Add '${implements OnChanges}' to the class.
            setTimeout(function () {
                _this.filterKeys1 = Object.keys(_this.list);
                _this.selectedFilterTabType1 = _this.filterKeys1[0];
                _this.fromTime = _this.paramList.fromTime;
                _this.toTime = _this.paramList.toTime;
                _this.listCopy = JSON.parse(JSON.stringify(_this.list));
                _this.isStatus = _this.list.isStatus;
                _this.category = _this.list.category;
                _this.isData = true;
            }, 2000);
        };
        GenericListFilterComponent.prototype.openFilterSideBar = function () {
            this.searchKey = '';
            this.list[this.selectedFilterTabType1] = this.listCopy[this.selectedFilterTabType1];
            this.openFilterBar = !this.openFilterBar;
        };
        GenericListFilterComponent.prototype.onCancel = function () {
            this.openFilterBar = false;
        };
        GenericListFilterComponent.prototype.onRemoveFilter = function (item) {
            if (item == 'time') {
                this.fromTime = moment__namespace().subtract(3, 'hours').format('LT');
                this.toTime = moment__namespace().format('LT');
                this.timeFilter = false;
            }
            delete this.allAppliedFilters[item];
            this.selectedValues = this.selectedValues.filter(function (obj) {
                return obj.type !== item;
            });
            console.log(item, this.allAppliedFilters, this.selectedValues);
            this.applyFilters();
        };
        GenericListFilterComponent.prototype.applyFilters = function () {
            this.isFiltersApplied = true;
            this.openFilterBar = false;
            var allAppliedFilters = {};
        ...
        GenericListFilterComponent.prototype.setTime = function (type, event) {
        ...
        GenericListFilterComponent.prototype.filterChange = function () {
            var filters = {
                isFilter: true,
        ...
        GenericListFilterComponent.prototype.openRestAppliedFilters = function () {
            this.isCountClicked = true;
        };
        GenericListFilterComponent.prototype.selectedFilterTab = function (type) {
            this.searchKey = '';
            var indx = _.findIndex(this.selectedValues, function (item) {
        ...
        GenericListFilterComponent.prototype.isFilterExists = function (filter) {
            var indx = _.findIndex(this.selectedValues, function (item) {
        ...
        GenericListFilterComponent.prototype.selectFilter = function (item, type) {
            var value = {
                type: type,
                value: item
            };
        ...
        GenericListFilterComponent.prototype.resetAllFilters = function () {
            this.fromTime = moment__namespace().subtract(3, 'hours').format('LT');
            this.toTime = moment__namespace().format('LT');
            this.isFiltersApplied = false;
            this.timeFilter = false;
        ...
        GenericListFilterComponent.prototype.filterData = function (searchValue) {
            this.list[this.selectedFilterTabType1] = this.listCopy[this.selectedFilterTabType1];
            var filterArr = this.list[this.selectedFilterTabType1];
            if (filterArr && filterArr.length) {
                var data = filterArr.filter(function (item) {
                ...
                this.list[this.selectedFilterTabType1] = __spread(data);
            }
        };
        return GenericListFilterComponent;
    }());
    ...
    GenericListFilterComponent.ctorParameters = function () { return []; };
    GenericListFilterComponent.propDecorators = {
        list: [{ type: core.Input }],
        paramList: [{ type: core.Input }],
        onFilterChange: [{ type: core.Output }]
    };

    var GenericListFilterModule = /** @class */ (function () {
        function GenericListFilterModule() {
        }
        return GenericListFilterModule;
    }());
    ...
    exports.GenericListFilterComponent = GenericListFilterComponent;
    exports.GenericListFilterModule = GenericListFilterModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=generic-list-filter.umd.js.map
